...
{
    public class ImportFromFileCommandHandler 
        : IRequestHandler<ImportFromFileCommand>
    {
        ...
        public async Task<Unit> Handle(ImportFromFileCommand request, CancellationToken cancellationToken)
        {
            ...
            var labels = document.Descendants("Label")
                .Where(l => l.Element("Property").Element("PropertyValue").Value.Any());
